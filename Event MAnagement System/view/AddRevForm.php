...
<p>Fill up data</p><br><br>
	...
	<form method="post" action="../view/addReview.php">
		<b>Your name:</b> <input type="text" name="clientId" placeholder="write your name"><br><br>
		<b>Vendor Name:</b> <input type="text" name="clientName" placeholder="write the the name of the vendor"><br><br>
